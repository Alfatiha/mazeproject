...
/**
 * normalizingAngle - normalizes the angle
 * @angle: the angle
 * Return: the normal angle
 */
float normalizingAngle(float angle)
{
...
{
	rayAngle = normalizingAngle(rayAngle);
...
/**
* renderingMap - rendering the map
* @instance: sdl instance
*/
void renderingMap(SDL_Instance instance)
{
	int i, j;
...
/**
 * rendererRays - renders rays
 * Return: nothing
 */
void rendererRays(SDL_Instance instance)
{
	int i;
